            ...
            >
                <div className='bg-[#030712] w-screen h-screen flex'>
                    ...
                    <div className='lg:pl-2 lg:pb-1 lg:pt-2 flex-1 overflow-y-auto'>
                        <div className='flex-1 bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 min-h-screen lg:rounded-xl border border-transparent lg:border-gray-700 overflow-y-auto flex flex-col mr-2'>
